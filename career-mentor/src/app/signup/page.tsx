  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {/* Submit */}
        <Button className="w-full h-12 bg-[#0F172A] hover:bg-[#020617] text-white rounded-xl font-semibold text-[15px] tracking-[-0.01em] shadow-[0_4px_12px_rgba(15,23,42,0.15)] transition-all active:scale-[0.98] mt-2">
          Get Started
        </Button>
      </div>
